...
class PlacesAutocompleteResult extends StatefulWidget {
  ...
  const PlacesAutocompleteResult({super.key, this.onTap, this.logo});
...
class AppBarPlacesAutoCompleteTextField extends StatefulWidget {
  ...
  const AppBarPlacesAutoCompleteTextField(
      {super.key, this.textDecoration, this.textStyle});
...
class PredictionsListView extends StatelessWidget {
  ...
  const PredictionsListView({super.key, required this.predictions, this.onTap});
